...
const Footer = () => {
    return (
        <footer className='bg-card px-4 md:px-0'>
            {/* Top area: Blocks */}
            <div className="mx-auto text-foreground grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-border container">
                {/* 1st block */}
                ...
                <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
                    ...
                    <ul className="text-sm">
                        <li className="mb-2">
                            <Link href="/cars" className=" transition duration-150 ease-in-out">
                                Cars & Vehicles
                            </Link>
                        </li>
                        <li className="mb-2">
                            <Link href="/jewelry" className=" transition duration-150 ease-in-out">
                                Jewelry
                            </Link>
                        </li>
                        <li className="mb-2">
                            <Link href="/music" className=" transition duration-150 ease-in-out">
                                Musical Instruments
                            </Link>
                        </li>
                        <li className="mb-2">
                            <Link href="/pets" className=" transition duration-150 ease-in-out">
                                Pets
                            </Link>
                        </li>
                        <li className="mb-2">
