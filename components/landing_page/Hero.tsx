  ...
  return (
    <section className="bg-card">
      <div className="py-8 px-4 mx-auto text-center lg:py-16 lg:px-12">
        ...
        <hr className="my-8" />
        <p className="my-4">This is a developers portfolio project and not a real website</p>
        <p  className="my-4">__Website is still under development - some features may be broken or not working__</p>
        <div className="px-4 mx-auto text-center md:max-w-screen-md lg:max-w-screen-lg lg:px-36">
          <span className="font-semibold text-gray-400 uppercase">Check out these two links below</span>
